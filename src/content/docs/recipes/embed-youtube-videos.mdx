...
description: Learn how to embed YouTube videos in your Astro + Starlight project.
---
...
This guide shows how to embed lightweight YouTube videos using [`lite-youtube-embed`](https://github.com/paulirish/lite-youtube-embed) in Astro/Starlight.
