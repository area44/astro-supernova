...
1. **Install the Plugin**  
   Install the [`rehype-external-links`](https://github.com/rehypejs/rehype-external-links) package as a dependency:

   <PackageManagerCommand command="add rehype-external-links" />

2. **Configure Astro to Use the Plugin**  
   Import the plugin and configure it in your `astro.config.mjs` file:
