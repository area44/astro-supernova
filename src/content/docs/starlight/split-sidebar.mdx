---
title: Split Your Starlight Sidebar into Tabs
...
3.  **Implement Tab Components**
    ...
    **`TabbedContent.astro`** (Manages state and switching):
    ...
    **`TabListItem.astro`** (The tab link):
    ...
    **`TabPanel.astro`** (Wraps the sidebar content):
