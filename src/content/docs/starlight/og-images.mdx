...
2.  **Create the image endpoint with this code**
    ...
    You can fully customize the template below, including layout, colors, fonts, and content, to match your project’s branding, see [Takumi Docs](https://takumi.kane.tw/docs/templates)
