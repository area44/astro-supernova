...
description: Add LaTeX rendering support to your Starlight site using KaTeX and Sätteri.
---
...
This guide shows you how to render LaTeX math formulas in your Starlight project using [`Sätteri`](https://satteri.bruits.org) and [`katex`](https://katex.org/).
