...
description: Mermaid Diagrams in Markdown.
---

import { Tabs, TabItem, Steps } from '@astrojs/starlight/components'

This guide helps you add Mermaid Diagrams in Markdown for Starlight/Astro projects.
...
1.  Start by installing the [`remark-mermaidjs`](https://github.com/remcohaszing/remark-mermaidjs) and [playwright](https://playwright.com):
    ...
    <Tabs>
      <TabItem label="npm">
        ```sh
        npm add remark-mermaidjs playwright playwright-chromium
        ```
      </TabItem>
      <TabItem label="pnpm">
        ```sh
        pnpm add remark-mermaidjs playwright playwright-chromium
        ```
      </TabItem>
      <TabItem label="Yarn">
        ```sh
        yarn add remark-mermaidjs playwright playwright-chromium
        ```
      </TabItem>
      <TabItem label="Bun">
        ```sh
        bun add remark-mermaidjs playwright playwright-chromium
        ```
      </TabItem>
    </Tabs>
2.  Setup Astro config:
    ...
    export default defineConfig({
      ...
      integrations: [
        starlight({
    +      customCss: [..., 'katex/dist/mermaid.css'],
        })
      ],
    })
    ```

3.  Custom some CSS for your diagrams:
